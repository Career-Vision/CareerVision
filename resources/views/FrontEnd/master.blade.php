...
<!-- Mirrored from html.kodesolution.live/s/counseling/v3.0/demo/index-mp-layout3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 08:53:31 GMT -->
<head>
...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
          ...
          <div class="rev_slider rev_slider_default" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/careerpath.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <li data-index="rs-2" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/girl.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-4">
              ...
              <p class="lead text-theme-colored">Your support will help us to make life better living for vulnerable tellus maximus lectus congue tincidun In hac habitasse.</p>
              <p>Nulla facilisis tellus maximus lectus congue tincidunt. In hac habitasse platea dictumst. Quisque malesuada mi imperdiet, commodo eros sed, aliquet tortor. Aenean id arcu in lacus semper gravida. Proin porta leo et facilisis pretium. </p>
              <a href="#" class="btn btn-theme-colored btn-sm btn-flat mb-sm-30">Read More</a>
            </div>
            <div class="col-md-4">
              <div class="icon-box text-center p-0 mb-sm-40 border-3px border-theme-colored p-30">
                <a href="#" class="icon">
                  <i class="fa fa-recycle font-54 text-theme-colored"></i>
                </a>
                <div>
                  <h4 class="icon-box-title mt-15 mb-10 text-uppercase letter-space-2"><strong>Remove Depression</strong></h4>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam a. </p>
                  <a href="#" class="btn btn-dark btn-theme-colored btn-sm mt-10">View Details</a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="icon-box text-center p-0 mb-sm-40 border-3px border-theme-colored p-30">
                <a href="#" class="icon">
                  <i class="fa fa-comments-o font-54 text-theme-colored"></i>
                </a>
                <div>
                  <h4 class="icon-box-title mt-15 mb-10 text-uppercase letter-space-2"><strong>Consulting Us</strong></h4>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam a. </p>
                  <a href="#" class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10">View Details</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <h2 class="title line-bottom mt-0 mb-30"><i class="fa fa-thumb-tack text-gray-darkgray mr-10"></i>Our <span class="text-theme-colored">Counselor</span></h2>
    ...
    <section class="divider parallax layer-overlay overlay-dark-6" data-bg-img="images/bg/bg5.jpg" data-parallax-ratio="0.7">
      <div class="container pt-120 pb-120"> 
        <!-- Section Content -->
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h3 class="text-white text-uppercase font-30 font-weight-600 mt-0 mb-20">Watch Our Latest consultant video</h3>
              <a href="https://www.youtube.com/watch?v=0dElYJnoNhk" data-lightbox-gallery="youtube-video"><i class="fa fa-play-circle text-theme-colored font-72"></i>
              </a>
            </div>
          </div>
        </div>
