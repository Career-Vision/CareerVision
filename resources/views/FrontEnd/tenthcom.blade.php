...
<!-- Mirrored from html.kodesolution.live/s/counseling/v3.0/demo/index-mp-layout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 09:13:13 GMT -->
<head>
...
<!-- Page Title -->
<title> Commerce After 10th</title>
          ...
          <div class="rev_slider rev_slider_default" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bt3.png"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <li data-index="rs-2" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/career6.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <li data-index="rs-3" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg3.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/boy.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
        ...
        <div class="row">
          <div class="call-to-action sm-text-center p-0 pt-30 pb-20">
            ...
            <div class="col-md-3 text-right flip sm-text-center"> 
              <a href="#" class="btn btn-default btn-circled btn-lg mt-5"> <i class="fa fa-angle-double-right font-16 ml-10"></i></a> 
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="about">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">Commerce After 10th</h2>
              <h4 class="text-theme-colored">You can select commerce stream after 10th. In commerce you can study various topics like Accountancy, Business studies, Economics, etc.</h4>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Students who deal with numbers easily and find it interesting, and who aim to shape their career in financial economics and business (corporate) world should take Commerce.</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Commerce directly or indirectly is linked with business, especially with the distribution aspect. Commerce helps in creating a proper distribution channel and creates a market for surplus commodities. It has been already proven that good commerce performs an enormous role in the economic development of a country.</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Chartered Accountancy or CA is another interesting career options for commerce students. Chartered Accountancy not only gives the benefit for private practice to an adequate chartered accountant but also give them a choice to start their own business.</p>
              <!-- <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Commerce and its education have become the backbone of every nation. The level of growth and the standard of living of the citizens are associated with the state of commerce in every distinct country. No nation can grow without the growth of commerce. The demands of the people are not confined to the goods manufactured in their countries only. They demand goods produced in other nations also.</p> -->
            ...
            <div class="col-md-6">
              <div class="row mb-10">
                <div class="col-sm-6 col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="images/bg/com.jfif" alt="">
                </div>
                <div class="col-sm-6 col-md-6 pl-5 pl-sm-15">
                  <img class="img-fullwidth" src="images/bg/comm2.jfif" alt="">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="images/bg/comm3.jfif" alt="">
                </div>
                <div class="col-sm-6 col-md-6 pl-5 pl-sm-15">
                  <img class="img-fullwidth" src="images/bg/comm4.jfif" alt="">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container pt-90 pb-90">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 mb-md-50">
          <div class="funfact text-center">
            ...
            <h5 class="text-white text-uppercase font-weight-600">Happy Students</h5>
          </div>
        </div>
...
<!-- Mirrored from html.kodesolution.live/s/counseling/v3.0/demo/index-mp-layout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 09:15:17 GMT -->
</html>