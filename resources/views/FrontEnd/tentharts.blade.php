    ...
    <section id="about">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">Arts After 10th</h2>
              <h4 class="text-theme-colored">The Subject Science Creates the mindset of the Student to have a more Practical Approach towards anything in life.</h4>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> After studying Science,a student can become a Doctor or an Engineer.He/She can achieve this goal by appearing in various competitive examinations such as IIT JEE,NEET etc.</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Science Students can get to study in top colleges of the country like IIT,AIIMS etc.</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> The Stream makes one feel that there are possibilities of a better future with healthy humanity.</p></p>
            ...
            <div class="col-md-6">
              <div class="row mb-10">
                <div class="col-sm-6 col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="images/bg/nolan.jpg" alt="">
                </div>
                <div class="col-sm-6 col-md-6 pl-5 pl-sm-15">
                  <img class="img-fullwidth" src="images/bg/arts2.jfif" alt="">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="images/bg/arts5.jfif" alt="">
                </div>
                <div class="col-sm-6 col-md-6 pl-5 pl-sm-15">
                  <img class="img-fullwidth" src="images/bg/arts6.jfif" alt="">
                </div>
              </div>
            </div>
          </div>
