...
<!-- Mirrored from html.kodesolution.live/s/counseling/v3.0/demo/index-sp-layout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 09:17:16 GMT -->
<head>
...
<!-- Page Title -->
<title>Counseling - Best Psychology & Counseling HTML5 Template</title>
...
<div id="wrapper" class="clearfix">
    ...
    <div class="header-top bg-black-333 sm-text-center border-top-theme-color-3px p-0">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2">
            <a class="btn btn-colored btn-flat btn-theme-colored ajaxload-popup pb-10" href="ajax-load/reservation-form.html">Reservation Form</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="main-content">
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider rev_slider_default" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway pl-30 pr-30"
                  ...
                  style="z-index: 7; white-space: nowrap; font-weight:400; border-radius: 30px;">Improve Your Family Life  
                </div>
                ...
                <div class="tp-caption" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-circled pl-20 pr-20" href="#">View Details</a> <a class="btn btn-theme-colored btn-circled pl-20 pr-20" href="#">Apply Now</a> 
                </div>
              </li>

              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:700;">counseling
                </div>
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/bg/bg3.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600;">counselor make at change you
                </div>
                ...
                <div class="tp-caption" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-lg btn-flat btn-theme-colored pl-20 pr-20" href="page-donate.html">Apply Now</a> 
                </div>
              </li>
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="call-to-action sm-text-center p-0 pt-30 pb-20">
            <div class="col-md-9">
              <h3 class="mt-5 text-white">Best Psychology & Counseling HTML Template Ever!</h3>
            </div>
    ...
    <section id="about">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">Welcome To Our Counselling</h2>
              <h4 class="text-theme-colored">Lorem ipsum dolor sit amet soluta saepe odit error, maxime praesentium sunt udiandae! soluta saepe odit errored Counselling sunt udiandae!</h4>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit maxime praesentium sunt udiandae soluta saepe dolor sit amet</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit maxime praesentium sunt udiandae soluta dolor sit amet</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit maxime praesentium.</p>
              <p> <i class="fa fa-hand-o-right text-theme-colored font-15"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit maxime</p>
            ...
            <div class="col-md-6">
              <div class="row mb-10">
                <div class="col-sm-6 col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="images/about/ab1.jpg" alt="">
                </div>
                <div class="col-sm-6 col-md-6 pl-5 pl-sm-15">
                  <img class="img-fullwidth" src="images/about/ab2.jpg" alt="">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="images/about/ab3.jpg" alt="">
                </div>
                <div class="col-sm-6 col-md-6 pl-5 pl-sm-15">
                  <img class="img-fullwidth" src="images/about/ab4.jpg" alt="">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase mt-0">Our <span class="text-theme-colored">Services</span></h2>
    ...
    <!-- Divider: Divider -->
    <section class="divider parallax layer-overlay ooverlay-dark-6" data-bg-img="images/bg/bg5.jpg" data-parallax-ratio="0.7">
      <div class="container pt-90 pb-90">
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-12 text-center">
            <h2 class="text-white font-28">For Emergency<span class="text-theme-colored font-weight-600"> Consulting</span> Please <span class="text-theme-colored font-weight-600"> Contact</span></h2>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-7 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <h3 class="text-uppercase title line-bottom mt-0 mb-30"><i class="fa fa-thumb-tack text-gray-darkgray mr-10"></i>Our <span class="text-theme-colored">Counselor</span></h3>
            ...
            <div class="col-md-5 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h3 class="text-uppercase title line-bottom mt-sm-20 mt-0 mb-30"><i class="fa fa-calendar text-gray-darkgray mr-10"></i>Upcoming <span class="text-theme-colored">Events</span></h3>
    ...
    <!-- Divider: Funfact -->
    <section class="divider parallax layer-overlay overlay-dark-6" data-bg-img="images/bg/bg2.jpg" data-parallax-ratio="0.7">
      <div class="container pt-90 pb-90">
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact text-center">
              ...
              <h5 class="text-white text-uppercase font-weight-600">Happy Clients</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact text-center">
              ...
              <h5 class="text-white text-uppercase font-weight-600">Success Story</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact text-center">
              <i class="pe-7s-add-user mt-5 text-white"></i>
              <h2 data-animation-duration="2000" data-value="248" class="animate-number text-theme-colored font-42 font-weight-500 mt-0 mb-0">0</h2>
              <h5 class="text-white text-uppercase font-weight-600">Our Counselor</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact text-center">
    ...
    <section id="gallery">
      <div class="container pt-50">
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title line-bottom mt-0 mb-30"><i class="fa fa-camera-retro text-gray-darkgray mr-10"></i>Photo <span class="text-theme-colored">Gallery</span></h2>
    ...
    <!-- Section: Client Say -->
    <section class="divider parallax layer-overlay overlay-dark-6" data-background-ratio="0.5" data-bg-img="images/bg/bg4.jpg">
      <div class="container pt-60 pb-60">
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <h2 class="line-bottom-center text-theme-colored text-center mt-0 mb-30">Our Clients say</h2>
    ...
    <section id="blog">
      <div class="container pt-50">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase mt-0">Latest <span class="text-theme-colored">News</span></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem<br> voluptatem obcaecati!</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="contact-details bg-white border-theme-color-1px p-30 pt-40 pr-20 pb-60">
              <h3 class="font-24 mb-20">If You have any query <span class="text-theme-colored">please contact</span> with us</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas, consequuntur laboriosam fugiat explicabo recusandae minima veniam ipsa ex fuga est eum tempora.</p>
              <ul class="list-icon theme-colored square mt-30">
                <li><i class="fa fa-map-marker text-white"></i><span class="font-weight-600 text-black-222">Address: </span>Village 856 Broadway New York</li>
                <li><i class="fa fa-phone text-white"></i><span class="font-weight-600 text-black-222">Phone: </span>+262 695 2601</li>
                <li><i class="fa fa-envelope-o text-white"></i><span class="font-weight-600 text-black-222">Email: </span>you@yourdomain.com</li>
                <li><i class="fa fa-fax text-white"></i><span class="font-weight-600 text-black-222">Fax: </span>6(600)123-456</li>
              </ul>
            </div>
          </div>
          <div class="col-md-7">
            <h3 class="line-bottom mt-0 mb-20 mt-sm-30">Leave Your <span class="text-theme-colored">Comment</span> Here</h3>
            ...
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="http://html.kodesolution.live/s/counseling/v3.0/demo/includes/sendmail.php" method="post">
              <div class="row">
                <div class="col-sm-6">
